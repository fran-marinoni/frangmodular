...
import fotoC from "@/assets/2. ESTACIONES/2. OBLIQ/2. METAL/Fotos proyectos/C.webp";
import fotoD from "@/assets/2. ESTACIONES/2. OBLIQ/2. METAL/Fotos proyectos/D.webp";

import configGer1 from "@/assets/2. ESTACIONES/2. OBLIQ/2. METAL/Configuraciones/Gerencias/OBLIQ 8.webp";
import configGer2 from "@/assets/2. ESTACIONES/2. OBLIQ/2. METAL/Configuraciones/Gerencias/OBLIQ 9.webp";
import configMesa1 from "@/assets/2. ESTACIONES/2. OBLIQ/2. METAL/Configuraciones/Mesa de Reuniones/OBLIQ 7.webp";
import configOp1 from "@/assets/2. ESTACIONES/2. OBLIQ/2. METAL/Configuraciones/Operativos/OBLIQ 1.webp";

import materiales from "@/assets/2. ESTACIONES/2. OBLIQ/2. METAL/MATERIALES/OBLIQ 10.webp";
...
const EstacionObliqMetal = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="Obliq Metal – Estación de trabajo | Generación Modular" description="Obliq Metal ofrece líneas contemporáneas con estructura metálica para estaciones de trabajo modernas." canonical="/estaciones/obliq-metal" />
      <Header />
        ...
        <section className="relative">
          <div className="grid grid-cols-1 md:grid-cols-2 w-full min-h-[85vh]">
            <div className="relative overflow-hidden min-h-[50vh] md:min-h-0">
              <img src={heroPhoto} alt="Estación Obliq Metal" className="w-full h-full object-cover absolute inset-0" />
            </div>
            <div className="flex flex-col">
              <div className="px-6 py-8 md:py-12 flex-1 flex flex-col justify-center">
                <h1 className="font-display text-6xl md:text-7xl lg:text-8xl font-black tracking-tight leading-none mb-4">Obliq<br/>Metal.</h1>
                <p className="text-xs leading-relaxed text-muted-foreground max-w-sm mb-6">
                  Obliq Metal ofrece líneas contemporáneas con estructura metálica resistente. Diseñada para entornos corporativos que priorizan durabilidad y estética moderna.
                </p>
              </div>
                  ...
                  <div key={item} className="border-b border-border last:border-b-0">
                    ...
                    {openAccordion === item && (
                      <div className="px-6 pb-4">
                        {item === "Materiales" ? (
                          <img src={materiales} alt="Materiales Obliq Metal" className="w-full max-w-md object-contain" />
                        ) : (
                          <p className="text-xs text-muted-foreground">
                            {item === "Colores disponibles" ? "Consulta con nuestro equipo las opciones de color disponibles." : `Información sobre ${item.toLowerCase()} del producto Obliq Metal.`}
                          </p>
                        )}
                      </div>
                    )}
        ...
        <section className="border-t border-border">
          <div className="grid grid-cols-1 md:grid-cols-2 min-h-[70vh]">
            <div className="relative overflow-hidden min-h-[50vh] md:min-h-0 bg-muted">
              <img src={fotoB} alt="Espacio Obliq Metal" className="w-full h-full object-cover absolute inset-0" />
...
export default EstacionObliqMetal;
