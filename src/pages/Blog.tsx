          ...
          {blogPosts.map((post, i) => (
            <div key={i} className="bg-background flex flex-col">
              ...
              <div className="p-6 md:p-8 flex flex-col flex-1">
                ...
                <div>
                  <Link to="/coming-soon" className="bg-primary text-primary-foreground text-[11px] font-bold px-6 py-2.5 rounded-[10px] border-2 border-foreground hover:bg-primary/80 hover:-translate-y-1 transition-all duration-200 tracking-wider inline-block">
                    Artículo completo
                  </Link>
                </div>
              </div>
